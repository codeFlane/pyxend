...
class Extension:
    ...
    def command(self, name: str, title: str | None = None):
        ...
        ### Using:
        ```python
        from pyvscode import Extension
        ...
        ### Context:
        on function execute, pyVScode add context to arguments.  
    ...
    def run_terminal_command(self, command: str, name: str = 'pyVScode terminal') -> None:
        """Run terminal command (create terminal, show it, execute command)

        ### Args:
            **command (str):** command to execute
            **name (str, optional):** terminal name. Defaults to pyVScode terminal
        """
