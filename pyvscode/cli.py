...
from pyvscode.parser import parse_decorators
from pyvscode.license_gen import generate_MIT
...
@click.group()
@click.version_option(version('pyvscode'), "-v", "--version", message="pyVScode version %(version)s")
def cli():
    pass
